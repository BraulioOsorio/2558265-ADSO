    ...
    public static void main(String[]args){
        ...
        while(opcion!=7){
            ...
            if(opcion==1){
                ...
                System.out.println("Ingrese un id para la factura");
                int numeroFac = entrada.nextInt();
                ...
                Factura factura = new Factura(numeroFac,VendedorSelect,clienteSelect);
