...
public class Pregunta4 extends AppCompatActivity {
    ...
    String respuesta2;
    String respuesta3;
    Button pregunta4_btn;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pregunta4);
        pregunta4_btn = findViewById(R.id.respuesta4);
        Bundle datos =getIntent().getExtras();
        respuesta1 = datos.getString("opcion1");
        respuesta2 = datos.getString("opcion2");
        respuesta3 = datos.getString("opcion3");
        radioGroup = findViewById(R.id.respuesta_4);
    }
    public void Preguntaa4(View vista){

        Intent intencion = new Intent(getApplicationContext(),Pregunta5.class);
        ...
        if (radioButtonId != -1) {
            ...
            intencion.putExtra("opcion4",opcionSeleccionada);
