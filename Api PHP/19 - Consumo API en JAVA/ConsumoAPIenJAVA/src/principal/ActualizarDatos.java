...
public class ActualizarDatos extends javax.swing.JFrame {
    ...
    ConsumoAPI ejemplo;
    Gson gson;
    public ActualizarDatos(ConsumoAPI ejemplo,Gson gson) {
        initComponents();
        this.gson = gson;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            updateData.put("telefono", telefonos);
            updateData.put("direccion", direcciones);
            updateData.put("email", correos);
            System.out.println("Consumo INSERT: " + ejemplo.consumoPOST("http://localhost/02APIenPHP/Update.php", updateData));
        } catch (Exception e) {
